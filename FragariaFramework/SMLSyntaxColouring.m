...
- (BOOL)textView:(NSTextView *)aTextView doCommandBySelector:(SEL)aSelector {
    id delegate = [document valueForKey:MGSFODelegate];
    if (delegate && [delegate respondsToSelector:@selector(textView:doCommandBySelector:)]) {
        [delegate performSelector:@selector(textView:doCommandBySelector:) withObject:aTextView withObject:NSStringFromSelector(aSelector)];
    }
